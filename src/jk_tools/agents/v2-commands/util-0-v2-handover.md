...
/util-0-v2-handover
  ...
  --domain "<slug>"                # optional; scope handover to a specific domain
...
HOVR/2
m:{ts:"<UTC>", plan:"<path or ?>", phase:"<name>", feat:"<slug or ?>", prog:"<x/y or %>", domain:"<slug or ? — optional>"}
...
# Handover
Plan: <path> • Phase: <name> • Feature: <slug> • Progress: <x/y or %> • Domain: <slug or ?> • Generated: <UTC ISO>
