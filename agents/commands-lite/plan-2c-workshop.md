---
description: Create detailed design documents for complex concepts identified in the spec's Workshop Opportunities, or any topic needing deep exploration.
---
...
Next steps:
  ...
  - Continue with /plan-3-architect
```
