---
description: Deep-dive research into existing codebase functionality. Auto-detects plan context or creates new plan folder.
---
...
def get_next_ordinal():
    # Use next available ordinal number (max existing + 1)
...
**Subagent 1: Implementation Archaeologist**
...
[Similar adaptations for other 5 subagents using Glob/Grep/Read, all including External Research Detection]

**Subagent 7: Prior Learnings Scout**
...
This command provides deep, actionable research into existing codebase functionality, filling the critical gap between needing to change something and understanding how it currently works. It integrates seamlessly with the planning workflow when desired.
