...
**Kind**: flight-plan · **Now**: review · **Next**: review · **Intent**: Ship-stage redesign: replace stage 8 merge with a ship verb (push + open PR + watch CI checks); demote local merge to a conditional 8c reconcile excursion; merge optional; best-effort. · **Nodes**: 5 · **Events**: 19
