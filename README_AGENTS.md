...
### `SDD/` — Spec-Driven Development (12 skills: 1 main flow + 11 utilities)
...
| `thesis` | Brief, flow-blind pre-work alignment — reads a request or existing thing and returns 2–4 one-sentence observations (Thesis / Now / Toward / Keep) plus a short synthesis, then stops. Read-only; orients before planning, coding, or delegating. |
